...
To use these stylesheets, rename the files and aflamenca with the name of your theme.
...
aflamenca-alpha-default-narrow.css  
...
aflamenca-alpha-default-normal.css
...
aflamenca-alpha-default-wide.css
